...
export const signupUser = createAsyncThunk("Signup User", async (userData: SignupFormData) => {
    try {
        const res = await axios.post("https://bet-net-3.onrender.com/api/v1/auth/signup", userData, { withCredentials: true })
...
export const signInUser = createAsyncThunk("SignIn User", async (userData: SigninFormData) => {
    try {
        const res = await axios.post("https://bet-net-3.onrender.com/api/v1/auth/signin", userData, { withCredentials: true })
...
export const sendVerificationCode = async () => {
    try {
        const res = await axios.post("https://bet-net-3.onrender.com/api/v1/auth/send-email-verifiction-code", {}, { withCredentials: true });
...
export const verifyEmail = createAsyncThunk("Verify Email", async (data: VerifyEmailCodeFormData) => {
    try {
        const res = await axios.post("https://bet-net-3.onrender.com/api/v1/auth/verify-email", data, { withCredentials: true });
...
export const signOutUser = createAsyncThunk("Sign Out User", async () => {
    try {
        await axios.post("https://bet-net-3.onrender.com/api/v1/auth/signout", {}, { withCredentials: true });
...
export const sendForgotPasswordEmail = createAsyncThunk("Send Forgot Password Email", async (email: string) => {
    try {
        const res = await axios.post("https://bet-net-3.onrender.com/api/v1/auth/send-forgot-password-code", { email }, { withCredentials: true });
...
export const resetPassword = createAsyncThunk("Reset Password", async (data: { email: string, forgotPasswordCode: string, password: string }) => {
    try {
        const res = await axios.post("https://bet-net-3.onrender.com/api/v1/auth/reset-password", data, { withCredentials: true });
